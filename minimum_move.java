...
class Solution {
    public int minMoves(String[] classroom, int energy) {
        ...
        State start = new State(startRow,startCol,0,energy,0);
        ...
        while (!queue.isEmpty()){
            ...
            for(int k =0;k< 4; k++){
                ...
                int newEnergy = current.remainingEnergy -1;
                ...
                if(!visited[nr][nc][newMask][newEnergy]){
                    ...
                    queue.offer(new State(nr,nc,newMask,newEnergy,current.moves +1));
                }
            }
        }
    ...
    static class State{
        ...
        State(int row,int col, int mask, int remainingEnergy, int moves){
            this.row = row;
            this.col = col;
            this.mask = mask;
